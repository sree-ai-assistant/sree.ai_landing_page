      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 md:gap-8 items-stretch mb-6 md:mb-8">
          ...
          <motion.div
            ...
            className="relative group rounded-3xl border border-emerald-500/30 bg-gradient-to-b from-[#0a1815]/95 via-[#070e17]/85 to-[#050614]/95 p-4 sm:p-7 md:p-8 backdrop-blur-2xl shadow-[0_0_50px_rgba(16,185,129,0.15)] flex flex-col justify-between overflow-hidden"
          >
              ...
              <div className="flex items-center justify-between gap-2.5 sm:gap-3 mb-4 sm:mb-5">
                <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-lg sm:text-2xl font-bold text-white tracking-tight leading-tight truncate">Android</h3>
                    <p className="text-[11px] sm:text-xs text-zinc-400 font-medium truncate">Native Mobile APK</p>
                  </div>
                </div>
          ...
          <motion.div
            ...
            className="relative group rounded-3xl border border-cyan-500/30 bg-gradient-to-b from-[#06121f]/95 via-[#070b1a]/85 to-[#050614]/95 p-4 sm:p-7 md:p-8 backdrop-blur-2xl shadow-[0_0_50px_rgba(6,182,212,0.15)] flex flex-col justify-between overflow-hidden"
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-2.5 sm:gap-3 mb-4 sm:mb-5">
                <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-lg sm:text-2xl font-bold text-white tracking-tight leading-tight truncate">macOS</h3>
                    <p className="text-[11px] sm:text-xs text-zinc-400 font-medium truncate">Native Mac App (.zip)</p>
                  </div>
                </div>
              ...
              <div className="mb-4">
                ...
                {showMacTips && (
                  <motion.div
                    ...
                    className="mt-2.5 p-3 sm:p-3.5 rounded-xl bg-white/[0.04] border border-white/10 text-[11px] sm:text-xs text-zinc-300 leading-relaxed space-y-1.5"
                  >
                    <p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="block md:hidden relative rounded-3xl border border-purple-500/25 bg-gradient-to-b from-[#0e0720]/90 via-[#0a0518]/90 to-[#07051a]/95 p-4 sm:p-6 backdrop-blur-2xl shadow-[0_0_40px_rgba(168,85,247,0.12)] overflow-hidden mb-6"
        >
          ...
          <div className="flex items-center justify-between gap-2.5 mb-3 sm:mb-4">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <h3 className="text-base sm:text-lg font-bold text-white tracking-tight leading-tight truncate">More Platforms</h3>
                <p className="text-[11px] sm:text-xs text-zinc-400 truncate">iOS & Windows Desktop</p>
              </div>
            </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-5 mb-6 md:mb-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.1 }}
            className="relative group rounded-2xl border border-purple-500/20 bg-[#07051a]/70 hover:border-purple-500/40 p-5 sm:p-6 backdrop-blur-xl transition duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-5"
          >
          ...
          <motion.div
            ...
            className="relative group rounded-2xl border border-blue-500/20 bg-[#07051a]/70 hover:border-blue-500/40 p-5 sm:p-6 backdrop-blur-xl transition duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-5"
          >
            <div className="flex items-start gap-3.5">
