    ...
    >
      <motion.nav
        ...
        animate={{
          ...
          height: mobileMenuOpen ? "auto" : scrolled ? "58px" : "70px",
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Launch Console Button: Icon-only (->) when < 910px, full text at >= 910px */}
            <a
              ...
              className={`relative group flex items-center justify-center gap-1.5 md:gap-2 rounded-full font-medium bg-blue-600 from-blue-600 via-indigo-600 to-purple-600 text-white shadow-[0_0_20px_rgba(59,130,246,0.35)] hover:shadow-[0_0_28px_rgba(59,130,246,0.55)] transition-all duration-300 cursor-pointer overflow-hidden ${scrolled
                ? "p-2 min-[910px]:px-4 min-[910px]:py-1.5 text-xs"
                : "p-2.5 min-[910px]:px-5 min-[910px]:py-2 text-xs md:text-sm"
                }`}
              title="Launch Console"
            >
              <span className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
              <span className="relative z-10 font-semibold tracking-wide hidden min-[910px]:inline">
                Launch Console
              </span>
              <ArrowRight className="relative z-10 h-4 w-4 min-[910px]:h-3.5 min-[910px]:w-3.5 group-hover:translate-x-0.5 transition-transform duration-200" />
            </a>
          </motion.div>
        ...
        {/* Seamless Inner Expanding Mobile Menu (< 500px) */}
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="w-full flex flex-col min-[500px]:hidden px-5 pb-6 pt-1 gap-3 overflow-hidden border-t border-white/10"
            >
