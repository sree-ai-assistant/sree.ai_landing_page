  ...
  return (
    <div className="w-full min-h-full bg-[#030014] text-zinc-100 relative overflow-x-hidden">
      ...
      <div className="overflow-x-clip font-sans">
        ...
        {/* HERO SECTION */}
        <section id="about" className="relative min-h-screen flex items-center justify-center pt-44 pb-16">
          ...
          <video
            ...
            loop
            playsInline
            className="absolute left-0 top-[-430px] z-[1] h-full w-full rotate-180 object-cover opacity-75 mix-blend-normal pointer-events-none"
          >
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center justify-center text-center">
            ...
            <div className="w-full mt-8 py-6 border-t border-b border-white/5 bg-[#030014]/50 backdrop-blur-sm">
        ...
        {/* SECTIONS BELOW HERO WITH THREE.JS COSMIC DUST BACKGROUND */}
